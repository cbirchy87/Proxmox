...
echo -e "${INFO}${YW} Wireguard Configuration:${CL}"
echo -e "${TAB}${GATEWAY}${BGN}Config location: /etc/wireguard/wg0.conf${CL}"
echo -e "${TAB}${GATEWAY}${BGN}Commands: wg-quick up wg0 | wg-quick down wg0${CL}"
